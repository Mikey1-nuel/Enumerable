...
Enumerable is a ruby project to learn the use of modules inside classes.
...
```
git clone https://github.com/Mikey1-nuel/Enumerable.git
```

### Usage
To run the project, execute the following command:<br>
- Type `irb` inside the termimal to open Interactive Ruby
- Copy and paste expressions from `my_list.rb`, `enumerable.rb` into terminal and check their results (press enter after typing each one)
...
Feel free to check the [issues page](https://github.com/Mikey1-nuel/Enumerable/issues).
